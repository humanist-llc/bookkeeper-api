...
@app.function(image=magentic_image, secrets=[Secret.from_name("openai-secret")])
@web_endpoint(method="POST")
def message(item: Dict) -> str:
    msg = item['msg']

    @chatprompt(UserMessage(msg or "Say hi if you can hear me!"), model=OpenaiChatModel("gpt-4o", api_key=os.environ["OPENAI_API_KEY"]))
